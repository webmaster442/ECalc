...
namespace ECalc.Classes
{
    ...
    internal class UnitConverter
    {
        ...
        /// <summary>
        /// Lists a unit array to a treeviewItem with sub items
        /// </summary>
        ...
        /// <summary>
        /// Fills a treeview with available categories
        /// </summary>
        /// <param name="Control">Target treeview control</param>
        public void FillTreeview(TreeView Control)
        {
            ...
            Control.Items.Add(ListCategory(FileSize, "File Size"));
        }

        /// <summary>
        /// Converts a treeview item to a unit category array
        /// </summary>
        /// <param name="item">TreeViewItem to parse</param>
        /// <returns>a unit category based on the TreeViewItem</returns>
